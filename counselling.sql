...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 13, 2021 at 06:27 PM
...
('snigdha', '$2y$10$4p54gLR2Vi9WCkIa5IHJ.egfEoUJ0/h/oPyJeTduSzZ7IU/9.3jfi'),
('shubham', '$2y$10$e/lEkXpNeApjCvFmHG5TX.1uG.WPygMG68t2XnDDlE/kNv9UUm7A6'),
('vibhu', '$2y$10$tbDIg8Lt3nxUzggcgPTe6umBzgrrqrx4X3YEdK5FfyA.LQFaMc9LO'),
('yashi', '$2y$10$jSFdmk.z3PKpAiiZACuqDOHpgENtvFLEXgm1jkOLOJljPJ5Dc1zni');
...
INSERT INTO `filter6` (`SNo`, `opening_rank`, `closing_rank`, `institute_id`, `branch_id`, `quota_id`, `seat_type_id`, `gender_type_id`, `region_id`, `branchp`, `regionsp`, `yoestd`, `placerank`, `camprat`) VALUES
(5, 13184, 14366, 6, 12, 1, 1, 2, 3, 0, 5, 2008, 8, 9),
(8, 15881, 15881, 6, 24, 1, 1, 2, 3, 0, 5, 2008, 8, 9),
(71, 12743, 15267, 4, 18, 3, 1, 2, 5, 0, 4, 1960, 9, 11),
(73, 13543, 15267, 10, 2, 2, 1, 2, 5, 1, 4, 2009, 7, 7),
(74, 13543, 15167, 14, 6, 2, 1, 2, 5, 0, 4, 1999, 6, 6),
(75, 13543, 15167, 10, 9, 2, 1, 2, 5, 0, 4, 2009, 7, 7),
(76, 13590, 15167, 21, 13, 2, 1, 2, 5, 0, 4, 1956, 12, 12),
(77, 13926, 14697, 19, 11, 2, 1, 2, 6, 0, 1, 2001, 20, 14),
(78, 13996, 14597, 17, 13, 1, 1, 2, 1, 0, 6, 1921, 18, 16),
(79, 13826, 14197, 12, 19, 1, 1, 2, 1, 0, 6, 2014, 13, 20),
(80, 13001, 15999, 11, 25, 1, 1, 2, 5, 0, 4, 1997, 14, 21),
(81, 13002, 15399, 15, 6, 1, 1, 2, 2, 0, 2, 2007, 17, 18);
...
('Raman', 'Raman Narayan', '', 10, 1234, 12123, 'Gender-Neutral', 'OPEN', 'adads@gmail.com'),
('shubham', 'Shubham Kumar Jha', '', 1, 23232, 23232, 'Gender-Neutral', 'OPEN', 'skjha@gmail.com'),
('snigdha', 'Snigdha Sharma', '', 1, 43243, 23233, 'Female-only (including Supernumerary)', 'OPEN', 'ss@gmail.com'),
...
('vibhu', 'Vibhu Rastogi', '', 7, 4456, 35543, 'Gender-Neutral', 'OPEN', 'vr@gmail.com'),
('yashi', 'Yashi Agrawal', '', 12, 2321, 12324, 'Female-only (including Supernumerary)', 'OPEN', 'ya@gmail.com');
...
('purva', '$2y$10$a9wY.b4AyX1NiyymKPnjbuSCYXPvZJhlskARErB0/iLTXPcNBLcEi'),
('shubham', '$2y$10$EIkMwicla2ezvWAqHaKgQedFOCJhDd6E3CYjIc/GELZqkM54D7FZq'),
('snigdha', '$2y$10$5mMt8HD8sywpzgmfus1a3eA9Lr0NBnrlghJOZmd/9DQ9GEJmo8/GC'),
('vibhu', '$2y$10$f/rCK//VbMhJ0OO/6BtP7uk/dIRrXcosytjggoDJyFkTJR0t7vCQi'),
('yashi', '$2y$10$A3VaZd0CECy8d.A5d7ErfuBmkETsTy56uFond5s/h/aaIoIkAZ0mq');
